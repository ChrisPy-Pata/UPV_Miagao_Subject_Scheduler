...
<body>
   <div>
       <header class="header-bg">
           <img src="crs-header.png" alt="Logo" id="crs-header">
       </header>       

       <img src="arrow.png" alt="Back" onclick="window.location.href='homepage.php'" class="back-arrow">
       <main>
               ...
               fetch('get_schedules.php?subject=' + encodeURIComponent(selectedSubject))
                   ...
                   .then(data => {
                       ...
                       data.forEach(schedule => {
                           ...
                           scheduleBox.appendChild(scheduleElement); // Append schedule element to the schedule box
                       });
                   })
       ...
       function deleteEnlistedSubject(subject) {
           fetch('delete_enlisted.php?subject=' + encodeURIComponent(subject))
               ...
               .then(result => {
                   console.log(result); // Log server response
                   alert(result);
                   // Remove the subject from the UI immediately upon successful deletion
